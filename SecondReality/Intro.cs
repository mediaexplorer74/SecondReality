        ...
        private void CreateRaindrops()
        {
            ...
            for (int i = 0; i < raindrops; i++)
            {
                ...
                var contourColored = contour.Select(v =>
                    new VertexPositionColor(v.Position, HSLtoRGB(new ColorHSL(((i * 720F / raindrops) + hueOffset) % 360, 1.0F, 
                    v.Color.A / 255F, v.Color.A)))
                    ).ToArray();
                ...
                rainboomVertexBuffers[i] = new VertexBuffer(device, typeof(VertexPositionColor), 
